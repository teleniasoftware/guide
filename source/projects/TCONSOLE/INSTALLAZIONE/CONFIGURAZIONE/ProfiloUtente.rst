...
Una volta visualizzato un profilo utente nella relativa finestra, da questa è possibile impostare abilitazioni, funzioni e permessi relativi all’utente:

- nel riquadro *Ruolo* a sinistra sono visibili le abilitazioni o funzionalità da utilizzare, **compatibilmente con la licenza disponibile** (ad es. viene utilizzata la Sintesi Vocale)
- nel riquadro *Permessi* a destra sono visibili le abilitazioni consentite dai vari ruoli e le configurazioni dei singoli parametri (funzionalità attiva/non attiva o valore del parametro)
...
- tra i parametri della funzionalità **M2250**:
  ...
  - *BRAILLE = NO*: nella console principale la Barra Braille non è abilitata; il parametro viene comunque ignorato in quanto nel riquadro *Ruolo* NON è presente il flag su **Braille**
  - *ABILITA SINTESI VOCALE = SI*: nella console principale la Sintesi Vocale è abilitata
  - *Rubrica Interna = SI*: la Rubrica Interna (F2) è abilitata e viene resa visibile, altrimenti di default è disponibile solo la Rubrica Esterna (F3)
  - *CAMPO LAMPADE = NO*: il Campo Lampade non è abilitato
  - *Sintesi su Numeri = SI*: all'arrivo di una chiamata, la Sintesi Vocale riproduce informazioni sul numero chiamante ("0452224660 su linea 0") o, se il numero è presente in rubrica ed il lookup è abilitato, viene letto il nominativo contenuto in rubrica. Se settato a *NO* viene riprodotto un messaggio generico del tipo "Chiamata entrante su linea 0".
  - *Sintesi su Keypad = SI*: alla pressione di una delle cifre del tastierino numerico (su tastiera del PC o sulla console), la Sintesi Vocale riproduce la cifra che viene di volta in volta digitata
  - *Blocca sintesi su Numeri dopo Risposta* (parametro non valorizzato, in questo caso viene considerato come valorizzato a *NO*): al momento della risposta ad una chiamata, la Sintesi Vocale riproduce informazioni sul numero chiamato (DNIS) e sul numero chiamante (CLID). Se valorizzato a *SI* la Sintesi Vocale non dice nulla al momento della risposta ad una chiamata
