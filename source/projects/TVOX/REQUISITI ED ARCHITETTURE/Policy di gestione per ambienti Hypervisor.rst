...
In riferimento agli ambienti basati su Hypervisor è bene precisare che gli applicativi Telenia NON risentono di perdite di performance e/o malfunzionamenti di sorta se e solo se la gestione delle VM ospitate seguono le best practices di settore (vedi `Nota di VMWare`_).
